...
"""
    ...
    html += 'You can download this script from <a href="http://bazaar.launchpad.net/~ubuntu-desktop/ubuntu-desktop-versions/trunk/files">lp:ubuntu-desktop-versions</a>\n'
    html += '</p>\n'
