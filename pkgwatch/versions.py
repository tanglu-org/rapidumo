...
"""
    ...
    foot_html += 'These pages are generated by pkgcheck (part of Rapidumo) (<a href="http://gitorious.org/tanglu/rapidumo">sources</a>). It contains code originally written for Ubuntu.\n'
    foot_html += '</p>\n'
